...
print(f"Pushing {len(updates_to_send)} post-event updates to Google Drive...")
...
print(f"\nCOMPLETED! {success_count} / {len(updates_to_send)} cells updated to DESOCUPADO in Google Sheets!")
