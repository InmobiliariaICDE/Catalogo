...
# Let's test with a real JS tokenizer or proper state machine
def parse_js(text, start_line_num):
    pos = 0
    length = len(text)
    line = start_line_num
    ...
    # State tracking: list of modes
    # mode can be: 'code', 'str_single', 'str_double', 'str_template', 'comment_line', 'comment_block'
    modes = ['code']
