...
const CONT_CAT_ICONS = {
  ...
  'Gestión/Administración':'💼','Consultoría':'💡','Diagnóstico':'🩺','Recaudo de cartera':'📥','Otro Servicio':'⭐',
...
function contToggleTipo(){
  ...
  const ingresosCats=['Venta de Inmueble','Separan Inmueble','Arriendo','Avalúos','Remodelación','Reparación','Arquitectura','Gestión/Administración','Consultoría','Diagnóstico','Recaudo de cartera','Otro Servicio'];
